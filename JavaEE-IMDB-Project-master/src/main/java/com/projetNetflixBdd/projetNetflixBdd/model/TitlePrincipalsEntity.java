...
public class TitlePrincipalsEntity {
    ...
    public TitlePrincipalsEntity(String tconst, String ordering, String nconst, String category, String job, String characters) {
        this.tconst = tconst;
    ...
    public int hashCode() {
        ...
        return Objects.hash(_id, tconst, ordering, nconst, category, job, characters);
    }
}
